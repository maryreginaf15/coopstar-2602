🚀 Recentemente finalizei a refatoração do projeto Coopstar, disponível no GitHub!

O projeto consiste em uma aplicação voltada para simulação/gerenciamento de serviços de transporte, com foco na organização de informações e experiência do usuário.

Durante esse processo, trabalhei com tecnologias como HTML, CSS e JavaScript, aplicando melhorias importantes para modernizar a aplicação.
